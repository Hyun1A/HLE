...
class EWCpp(ER):
    ...
    def online_train(self, sample, batch_size, n_worker, iterations=1, stream_batch_size=1):
        ...
        if num_data_sup != 0:
            train_loss_sup = total_loss_sup / num_data_sup
            train_acc_sup = correct_sup / num_data_sup
        else:
            train_loss_sup = 0.
            train_acc_sup = 0.         

        if num_data_sub != 0:
            train_loss_sub = total_loss_sub / num_data_sub
            train_acc_sub = correct_sub / num_data_sub
        else:
            train_loss_sub = 0.
            train_acc_sub = 0.                     
