...
def base_parser():
    ...
    # CLIB
    parser.add_argument("--imp_update_period", type=int, default=5,
    ...
    parser.add_argument('--tau', type=float, default=0.75, help='temperature')
    ...
    parser.add_argument('--gamma', type=float, default=1.0, help='threshold for openmatch')
    parser.add_argument('--lamb', type=float, default=1.0, help='regularization parameters for openmatch')
