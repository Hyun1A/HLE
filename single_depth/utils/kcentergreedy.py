...
class kCenterGreedy(SamplingMethod):
    ...
    def select_batch_(self, already_selected, N, **kwargs):
        ...
        print('Maximum distance from cluster centers is %0.10f'
...
def get_kcg(model, dataset, select_loader, device, batch_size):
    ...
    with torch.no_grad():
        for idx in idxlist:
            ...
            _, _, features_batch = model(x, return_feat=True)
    ...
    #print(feat..shape[0])
    batch = sampling.select_batch_(new_av_idx, feat.shape[0])
    print(batch)
