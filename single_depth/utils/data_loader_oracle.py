...
""""""
def cutmix_data_pair(x_pair, y, alpha=1.0, cutmix_prob=0.5, cls_sup=None, cls_sub=None):
    assert alpha > 0
    # generate mixed sample
    lam = np.random.beta(alpha, alpha)
    ...
    #print(index)
    y_a, y_b = y, y[index]
    cls_sup_a, cls_sup_b = cls_sup, cls_sup[index]
    cls_sub_a, cls_sub_b = cls_sub, cls_sub[index]
    cls_ = {'cls_sup_a': cls_sup_a, 'cls_sup_b': cls_sup_b, 'cls_sub_a': cls_sub_a, 'cls_sub_b': cls_sub_b,}
