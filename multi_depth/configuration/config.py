...
def base_parser():
    ...
    parser.add_argument('--lr_period', type=int, default=1, help='period of iterating lr for adaptive LR')
    ...
    parser.add_argument('--depth', type=int, default=0, help='depth of hierarchy')
